...
export default class Jaccard {
   ...
   * @returns {number} - The Jaccard similarity coefficient between the two sets, ranging from 0.0 (no similarity) to 1.0 (perfect similarity).
   */
  static similarity<T>(s1: Set<T>, s2: Set<T>): number {
